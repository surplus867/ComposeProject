...
import com.example.composeProject.components.DisplayAlertDialog
...
import com.example.composeProject.util.TrailingIconState
                    ...
                    onClick = {
                        when (trailingIconState) {
                            TrailingIconState.READY_TO_DELETE -> {
                                onTextChange("")
                                trailingIconState = TrailingIconState.READY_CLOSE
                            }

                            TrailingIconState.READY_CLOSE -> {
                                if (text.isNotEmpty()) {
                                    onTextChange("")
                                } else {
                                    onCloseClicked()
